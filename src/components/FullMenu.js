...
// --- COMPONENT ---
const FullMenu = () => {
    return ((0, jsx_runtime_1.jsxs)("section", { className: "full-menu-section", id: "full-menu", children: [(0, jsx_runtime_1.jsx)("h2", { className: "section-heading", children: "Full Menu & Prices" }), (0, jsx_runtime_1.jsx)("p", { className: "section-subheading", children: "All your authentic Italian dishes in one place." }), (0, jsx_runtime_1.jsx)("div", { className: "menu-container-wrap", children: FULL_MENU.map((category) => ((0, jsx_runtime_1.jsxs)("div", { className: "menu-category", children: [(0, jsx_runtime_1.jsxs)("h3", { className: "category-title", children: [(0, jsx_runtime_1.jsx)("span", { className: "icon", children: category.icon }), " ", category.title] }), (0, jsx_runtime_1.jsx)("div", { className: "item-list", children: category.items.map((item) => ((0, jsx_runtime_1.jsxs)("div", { className: `menu-item-wrapper`, children: [(0, jsx_runtime_1.jsx)("div", { className: "item-thumb", children: (0, jsx_runtime_1.jsx)("img", { 
                                            // Uses item.imageUrl, which is always present now.
                                            src: item.imageUrl, alt: item.name, className: "item-image-thumb" }) }), (0, jsx_runtime_1.jsxs)("div", { className: "menu-item-row", children: [(0, jsx_runtime_1.jsxs)("div", { className: "item-details", children: [(0, jsx_runtime_1.jsx)("div", { className: "item-name", children: item.name }), item.description && ((0, jsx_runtime_1.jsx)("div", { className: "item-description-small", children: item.description }))] }), (0, jsx_runtime_1.jsx)("div", { className: "item-price-small", children: item.price })] })] }, item.name))) })] }, category.title))) })] }));
};
exports.default = FullMenu;
//# sourceMappingURL=FullMenu.js.map